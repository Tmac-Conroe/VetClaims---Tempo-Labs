      ...
      <main className="flex-1 p-4 md:p-6">
        <div className="container mx-auto max-w-5xl">
          ...
          <section className="flex flex-col items-center justify-center mt-4 space-y-3">
            ...
            <button
              className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-6 rounded-md max-w-xs w-full md:w-64 opacity-50 cursor-not-allowed transition-colors shadow-sm"
              disabled
